...
const GetShopProperty = ({shopProperties}) => {
    console.log(shopProperties);
    return (
        <div>
            <h1 className="text-2xl font-semibold my-3 text-blue-600">Shop Properties</h1>
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6'>
           {
            shopProperties?.map((data, idx) => 
            <div key={idx}>
            <div className="w-full cursor-pointer group hover:shadow-2xl hover:shadow-gray-400 overflow-hidden border bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                :
                <img className="object-cover group-hover:scale-110 transition duration-300 ease-in-out w-full h-20" src='https://rents.com.bd/wp-content/uploads/2020/12/Tolet-image.jpg' alt="avatar" />
                }
...
export default GetShopProperty;